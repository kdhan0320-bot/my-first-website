    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          top: '-14%', left: '-12%',
          width: '145%', height: '78%',
          background: 'linear-gradient(100deg, transparent 26%, rgba(56,189,248,0.19) 47%, rgba(129,140,248,0.15) 53%, transparent 74%)',
          filter: 'blur(28px)',
          zIndex: 0,
          pointerEvents: 'none',
      ...
      <Box
        ...
        sx={{
          ...
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(56,189,248,0.072) 0%, transparent 70%)',
          zIndex: 0,
          pointerEvents: 'none',
          filter: 'blur(52px)',
        }}
