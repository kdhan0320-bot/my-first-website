...
const MOCK_NOTIFICATIONS = [
  ...
  },
  {
    ...
    user: "모바일 UI 스터디",
    content: "모임이 시작되었습니다. 채팅방을 확인하세요.",
    time: "5분 전",
    postImage: null,
  },
  {
        ...
        <PageHeroHeader
          ...
          chips={
            <>
              ...
              <Chip label="모임 소식" size="small" sx={heroChipSx} />
            </>
          }
          flowLabel="흐름"
          flowText="피드 반응과 모임 업데이트를 빠르게 확인합니다"
          featureText="읽지 않음 / 반응 알림 / 모임 업데이트"
        />
