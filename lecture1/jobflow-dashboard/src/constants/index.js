...
export const NAV_ITEMS = [
  ...
  { path: '/checklist', label: 'Checklist', icon: 'Checklist' },
  { path: '/interview', label: 'Interview', icon: 'QuestionAnswer' },
  { path: '/ai-prompt', label: 'AI Prompt', icon: 'AutoAwesome' },
...
export const DEMO_INTERVIEW_NOTES = [
  {
    id: 'in-1',
    question: '자기소개를 해주세요.',
    answer: '안녕하세요. 저는 UX/UI 기반 웹디자이너로 Mini SNS, Portfolio Feedback Hub 등을 제작했습니다.',
