...
export const getDesignTokens = (mode) => ({
  palette: {
    ...
    text: {
      primary:   mode === 'dark' ? '#E5E7EB' : '#162033',
      secondary: mode === 'dark' ? '#94A3B8' : '#64748B',
      disabled:  mode === 'dark' ? '#4B5563' : '#B0BAC8',
    },
    divider: mode === 'dark' ? 'rgba(148,163,184,0.18)' : 'rgba(37,99,235,0.12)',
    highlight: {
      background: mode === 'dark' ? 'rgba(96,165,250,0.12)' : '#EAF3FF',
    },
    error:   { main: '#E53935' },
    warning: { main: '#FFB800' },
    success: { main: '#2E7D32' },
